...
public class SignInController  {
    ...
    void Login(ActionEvent event) {
        User user1 = new User(Username.getText(), String.valueOf(Password.getText().hashCode()));
        if(user1.authenticate(Username.getText(), String.valueOf(Password.getText().hashCode()))){
            try {
                if (rs.next()) {
